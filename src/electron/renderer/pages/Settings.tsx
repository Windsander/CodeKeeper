...
function EverosGroup({
  ...
  return (
    <div className="config-section" style={{ marginBottom: 16 }}>
      <h6 className="config-section-title" style={{ marginBottom: 12, color: 'var(--text-secondary)' }}>{title}</h6>
